 ...
 *
 * @category   Upgradelabs
 * @package    SwissZipCodeResolver
 * @copyright  Copyright (c) 2007 - 2016 Onlime Webhosting (https://www.onlime.ch)
 * @license    http://www.apache.org/licenses/LICENSE-2.0
 */

namespace Upgradelabs\SwissZipCodeResolver;

use Upgradelabs\SwissZipCodeResolver\Exception\ConnectException;
use Upgradelabs\SwissZipCodeResolver\Exception\Exception;
use Upgradelabs\SwissZipCodeResolver\Exception\NotFoundException;
use Upgradelabs\SwissZipCodeResolver\Exception\OpenFileException;
use Upgradelabs\SwissZipCodeResolver\Exception\WriteFileException;
